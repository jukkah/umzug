...
describe('JSONStorage', () => {
    ...
    describe('constructor', () => {
        ...
        it('should not require any parameters', () => {
            ...
            expect(fs.__getMockFiles()).toEqual(EMPTY_FS);
        });
    ...
    describe('executed', () => {
        ...
        it('should resolve to string array if called without parameters', () => {
            fs.__setMockFiles(NON_EMPTY_FS_2);
            ...
            return storage.executed()
                .then((value) => {
                    ...
                    expect(fs.writeFile).not.toBeCalled();
                    expect(fs.__getMockFiles()).toEqual(NON_EMPTY_FS_2);
                });
        });
        ...
        it('should create the json file if it doesn\'t exist', () => {
            return storage.log('20160911222845-task')
                .then(() => {
                    ...
                    expect(fs.writeFile).not.toBeCalled();
                    expect(fs.__getMockFiles()).toEqual({
                        [CUSTOM_PATH]: [
    ...
    describe('unlog', () => {
        ...
        beforeEach(() => {
            fs.__setMockFiles(NON_EMPTY_FS_3);
            storage = new JSONStorage({ path: CUSTOM_PATH });
        });
        ...
        it('it should not require any parameters', () => {
            return new Promise((resolve) => {
                ...
                expect(fs.readFile).not.toBeCalled();
                expect(fs.writeFile).not.toBeCalled();
                expect(fs.__getMockFiles()).toEqual(NON_EMPTY_FS_3);
            });
        });
