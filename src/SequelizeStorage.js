...
export default class SequelizeStorage extends Storage {
   ...
   * _name_ and _timestamp_ for storing migrations. The model name, table name,
   * name column, and timestamp column are customizable with options.
   *
   * @example
   * let Sequelize = ...
   * let sequelize = ...
   ...
   * @param {string} [options.name.columnName='name'] Name of the column holding
   *     migration name.
